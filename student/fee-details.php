                ...
                <div class="card">
                    <div class="card-body">
                        <div class="invoice-title">
                            ...
                            <div class="mb-4">
                                <h2 class="mb-1 text-muted">College Fees</h2>
                            </div>
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT m.meta_value as `month` FROM `posts` as p JOIN `metadata` as m ON p.id = m.item_id WHERE p.type = 'payment' AND p.author = $std_id AND m.meta_key = 'month' AND year(p.publish_date) = 2025";
