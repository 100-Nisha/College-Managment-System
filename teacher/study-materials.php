            ...
            <div class="table-responsive bg-white">
              <table class="table table-bordered">
                ...
                <tbody>
                      ...
                      $count = 1;
                     // $query = mysqli_query($db_conn, "SELECT * FROM `posts` as p JOIN `metadata` as m ON p.id = m.item_id WHERE p.`type` = 'study-material' AND m.meta_key = 'class AND m.meta_value = $class");
