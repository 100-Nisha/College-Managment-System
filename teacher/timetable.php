                        ...
                        <div class="col-lg">
                            <div class="form-group" id="section-container">
                                ...
                                <select require name="teacher_id" id="teacher_id" class="form-control">
                                    ...
                                    <option value="2">Teacher 3</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg">
                        ...
                        <div class="col-lg">
                            <div class="form-group" id="section-container">
                                ...
                                <select require name="subject_id" id="subject_id" class="form-control">
                                    ...
                                    <option value="21">html</option>
                                    <option value="22">css</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        foreach($periods as $period){ 
                           ...
                           $from_metadata = get_metadata($period->id, 'from');
                           $to_metadata = get_metadata($period->id, 'to');
                   
                           $from = isset($from_metadata[0]->meta_value) ? $from_metadata[0]->meta_value : '';
                           $to = isset($to_metadata[0]->meta_value) ? $to_metadata[0]->meta_value : '';
                            ?>
                        <tr>
                                    ...
                                    while($timetable = mysqli_fetch_object($query)) {
                                        ...
                                        <td>
                                            <p>
                                                <b>Teacher: </b> 
                                                <?php 
                                                $teacher_meta = get_metadata($timetable->item_id,'teacher_id');
                                                $teacher_id = !empty($teacher_meta) ? $teacher_meta[0]->meta_value : 'N/A';
                                                $teacher_data = get_user_data($teacher_id);
                                                echo is_array($teacher_data) && isset($teacher_data['name']) ? $teacher_data['name'] : 'Unknown';
                                                
                                                //$teacher_meta = get_metadata($timetable->item_id, 'teacher_id');
                                               // $teacher_id = get_metadata($timetable->item_id,'teacher_id')[0]->meta_value;  
                                               //$teacher_id = !empty($teacher_meta) ? $teacher_meta[0]->meta_value : 'N/A'; // Default to 'N/A' if not found
                                                ...
                                                <b>Class: </b> 
                                                <?php 
                                                $class_meta = get_metadata($timetable->item_id,'class_id');
                                                $class_id = !empty($class_meta) ? $class_meta[0]->meta_value : 'N/A';
                                                $class_post = get_post(array('id'=>$class_id));
                                                echo !empty($class_post) ? $class_post->title : 'Unknown';
                                               ...
                                               //$class_meta = get_metadata($timetable->item_id, 'class_id');
                                                ...
                                                <b>Section: </b>
                                                <?php 
                                                $section_meta = get_metadata($timetable->item_id,'section_id');
                                                $section_id = !empty($section_meta) ? $section_meta[0]->meta_value : 'N/A';
                                                $section_post = get_post(array('id'=>$section_id));
                                                echo !empty($section_post) ? $section_post->title : 'Unknown';
                                               ...
                                               // $section_id = get_metadata($timetable->item_id,'section_id',)[0]->meta_value;
                                                ...
                                                <b>Subject: </b> 
                                                <?php
                                               $subject_meta = get_metadata($timetable->item_id,'subject_id');
                                               $subject_id = !empty($subject_meta) ? $subject_meta[0]->meta_value : 'N/A';
                                               $subject_post = get_post(array('id'=>$subject_id));
                                               echo !empty($subject_post) ? $subject_post->title : 'Unknown';
