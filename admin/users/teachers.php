                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="teaching_area[]" id="" class="form-control select-2-multi-select" multiple>
                                            ...
                                            $teaching_areas = [
                                                'Junior' => 'Junior (IT)',
                                                'Graduate' => 'Graduate (FY, SY, Ty)',
                                                'Post-Graduate' => 'Post-graduate (MCA, MSc)',
                                            ];
...
<script>
    ...
    jQuery('#teacher-registration').on('submit', function(e) {
        ...
        if (true) {
            ...
            jQuery.ajax({
            type: "post",
            //url: "http://localhost:8012/MCA_FinalProject/admin/ajax.php",
            url: "http://localhost:8012/MCA_FinalProject/actions/student-registration.php",
            data: formdata,
            cache: false,
            contentType: false,
            processData: false,
            ...
            success: function(response) {
                // console.log(response);
                 location.href = 'http://localhost:8012/MCA_FinalProject/admin/user-account.php?user=student';
            },
            complete: function() {
                // jQuery('#loader').hide();
            }
...
<div class="modal fade" id="user-import-modal" aria-hidden="true" style="display: none;">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="http://localhost:8012/MCA_FinalProject/actions/student-registration.php" method="post" enctype="multipart/form-data">
