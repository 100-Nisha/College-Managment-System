    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- Dashboard -->
          <li class="nav-item">
            <a href="<?=$site_url?>parent/dashboard.php" class="nav-link" style="color: #ffffff;">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=$site_url?>parent/courses.php" class="nav-link" style="color: #ffffff;">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Courses</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=$site_url?>parent/subjects.php" class="nav-link" style="color: #ffffff;">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Subjects</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=$site_url?>parent/periods.php" class="nav-link" style="color: #ffffff;">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Periods</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=$site_url?>parent/timetable.php" class="nav-link" style="color: #ffffff;">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Time Table</p>
                </a>
              </li>
          ...
          <!-- <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
               <li class="nav-item">
                <a href="<?=$site_url?>parent/attendance.php" class="nav-link" style="color: #ffffff;">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Attendance</p>
                </a>
              </li> 
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=$site_url?>parent/student-fee.php" class="nav-link" style="color: #ffffff;">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tuition Fee</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=$site_url?>parent/study-materials.php" class="nav-link" style="color: #ffffff;">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Study Materials</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <!-- <li class="nav-item">
                <a href="<?=$site_url?>parent/parent-meeting.php" class="nav-link" style="color: #ffffff;">
                  <i class="far fa-circle nav-icon"></i>
